...
### Ranking
Ver [ranking](https://github.com/cgarciae/supervised-basico-spirals/blob/master/ranking.md).
...
```bash
git clone https://github.com/{username}/supervised-basico-spirals
cd supervised-basico-spirals
```
